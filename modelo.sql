...
--* Bill
INSERT INTO bill (title, amount, "date", status, location, receiptimage, groupid, type, comments) VALUES 
('Finance Group Meeting Expenses', 500, TO_DATE('2024-01-10', 'YYYY-MM-DD'), 'Pending', 'New York', NULL, 1, 'Business', 'Meeting and accommodation costs');
INSERT INTO bill (title, amount, "date", status, location, receiptimage, groupid, type, comments) VALUES 
('Travel Group Trip Expenses', 600, TO_DATE('2024-01-15', 'YYYY-MM-DD'), 'Pending', 'Los Angeles', NULL, 2, 'Travel', 'Shared travel and food expenses');
INSERT INTO bill (title, amount, "date", status, location, receiptimage, groupid, type, comments) VALUES 
('Study Group Stationery Purchase', 200, TO_DATE('2024-02-05', 'YYYY-MM-DD'), 'Pending', 'Online', NULL, 3, 'Office', 'Books and other stationery items');
